...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``demo/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
dbutils.widgets.text("model_name", "dev.mlops_sindhu.demo-model", "Full (Three-Level) Model Name")
