...
# ``mlops_sindhu/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_sindhu-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.mlops_sindhu.mlops_sindhu-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_sindhu.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_sindhu.trip_dropoff_features",
