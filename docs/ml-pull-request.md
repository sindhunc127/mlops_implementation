...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/demo-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/staging/demo/demo-model)
* [Prod model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/prod/demo/demo-model)
. 
