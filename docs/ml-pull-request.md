...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_sindhu-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/staging/mlops_sindhu/mlops_sindhu-model)
* [Prod model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/prod/mlops_sindhu/mlops_sindhu-model)
. 
