...
git add README.md docs .gitignore demo/resources/README.md
...
- **`demo-tests-ci.yml`**:<br>
  - **[CI]** Performs unit and integration tests<br>
    - Triggered on PR to main
- **`demo-bundle-cicd.yml`**:<br>
  - **[CI]** Performs validation of Databricks resources defined under `demo/resources`<br>
...
1. Create a new variable group called `demo variable group` defining the following secret variables, for more details [here](https://learn.microsoft.com/en-us/azure/devops/pipelines/library/variable-groups?view=azure-devops&tabs=classic#create-a-variable-group):
...
Follow the instructions in [demo/resources/README.md](../demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../demo/resources/README.md)  to propose, test, and deploy
