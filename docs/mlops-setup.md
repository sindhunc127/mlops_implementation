...
git add README.md docs .gitignore mlops_sindhu/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_sindhu/databricks.yml](../mlops_sindhu/databricks.yml) file.
...
Follow the instructions in [mlops_sindhu/resources/README.md](../mlops_sindhu/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_sindhu/resources/README.md)  to propose, test, and deploy
